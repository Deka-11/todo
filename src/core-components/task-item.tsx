...
export default function TaskItem({task, loading}: TaskItemPros) { 
...
setTaskTitle(e.target.value || "")
   ...
   async function handleSaveTask(e: React.FormEvent<HTMLFormElement>) {
    ...
    function handleChangeTaskSatatus(e: React.ChangeEvent<HTMLInputElement>) {
            ...
            {!isEditing ? (
                <div className="flex items-center gap-4">
                    <InputCheckbox
                        ...
                        onChange={handleChangeTaskSatatus}
                        loading={loading}
